...
$string['eventhistory_help'] = "Report of all the events generated by Stash, related to this user. After pressing 'Get the events' you will se a table displaying the events. The table shows the date when the event was triggered, the user that produced the event, the user that was affected by the event and the event's description. If the description states that the user acquired the item via 'modification' or 'elimination' the quantity shown is the quantity with which the user ended";
